        ...
        <div className="container">
          <div className="row justify-center">
            ...
            <div className="col-10 md:col-8 lg:col-6">
              <div className="h-[323px] md:h-[623px] rounded-2xl animate-pulse bg-neutral-200 dark:bg-neutral-700 mb-4"></div>
                ...
                {Array(4)
                  ...
                  .map((_, index) => {
                    return (
                      <div
                        key={index}
                        className="h-[80px] md:h-[146px] rounded-2xl animate-pulse bg-neutral-200 dark:bg-neutral-700"
                      ></div>
                    );
                  })}
              </div>
              ...
              {Array(8)
                ...
                .map((_, index) => {
                  return (
                    <div
                      key={index}
                      className="h-20 mb-4 rounded-2xl animate-pulse bg-neutral-200 dark:bg-neutral-700"
                    ></div>
                  );
                })}
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {Array(9)
              ...
              .map((_, index) => {
                return (
                  <div key={index}>
                    <div className="h-[150px] md:h-[269px] rounded-2xl animate-pulse bg-neutral-200 dark:bg-neutral-700" />
